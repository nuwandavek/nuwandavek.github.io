var data = [
	{	
		...
		{	
			...
			'id' : 'R3',
			'name' : 'Live at the Apollo 13',
			'image' : 'res/projects/standup.jpg',
			'subhead' : 'Stand-up Comedy',
            'description' : 'This was my first attempt at standup-comedy, on 30th October 2015. I spoke about disappointment, intolerance, my family name, cows and a certain group on campus, in no particular order. I was fairly certain I was going to get beaten up by at least two groups related to the above mentioned topics.',
            ...
            'description' : 'A comic blog, outlining my various states of mind. It is usually silly, juvenile, unnecessarily introspective and often times falls painfully short of being funny. But it has a lot of stick-figures, so what the hell.',
			'demoLink' : 'https://thegreybit.wordpress.com/',
			'codeLink' : '#',
		},]
	},{	
		'id' : 'section_5',
		...
		{	
			...
			'subhead' : 'Analysis of a Debate Tournament',
            'description' : 'A visualization of the NLS debate tournament 2015, using d3js. The effort was to highlight the discrepancies in the breaking teams (qualify post preliminary rounds) of various gender compositions. Also, this would serve as a good way for debaters to identify what tournaments to attend, based on the average and distribution of speaker scores and adjudicator scores in the tournament.',
			...
			'subhead' : 'The KGP Census',
            'description' : 'This is a visualization of the UG population distribution at IIT Kharagpur - a census of sorts.The data is categorized by departments, and upon clicking a particular department, one can explore its composition. The female-male glyphs display the overall percentage compositions of a department, while the bars at the bottom represent distribution according to the year of admission. Hover over the bars to get the exact number of people and percentages. You can also sort the department list by sex-ratio, strength or even alphabetically, if that is how you roll. <br> This could be expanded for other colleges, and for other aspects of KGP-life. This was important in resistance against the tyranny of badly designed MS excel bar plots.',
			...
			'subhead' : 'Attendance viz of Loksabha of India',
            'description' : "This was an effort to visualize and measure the attendance of Members of Parliament, aggregating them by elected state and political parties",
			...
			'subhead' : 'Visualization of Soc-cult Championships of IITKGP',
            'description' : "The 'General Championship Dashboard' was a project to visualize and analyze the results of the Inter-hall Social and Cultural General Championship, at IIT Kharagpur. The aim was to integrate and accumulate all the Facebook posts by The Scholars' Avenue, the campus news body, at one place. Based on previous results, the hypothesis that halls have niche events that they choose to focus mainly on, was verified. Despite the hall allotment being done randomly, there is a clear pattern in the results. This strengthens the idea that the results are less dependent on skills of individuals at the time of joining the hall, and more on existing skill-set of the hall, that can be taught and the preference of the said hall.",
